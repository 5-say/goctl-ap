...
// Command provides the entry to generate typescript codes
...
// 	logx.Must(genHandler(dir, webApi, caller, plugin.Api, unwrapApi))
// 	logx.Must(genComponents(dir, plugin.Api))
